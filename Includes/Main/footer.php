<footer class="footer footer-v1">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <img src="https://1.bp.blogspot.com/-BSKo93yEzJI/YSF4-ziiOCI/AAAAAAAAHaI/WmIqAZGNbhIm37tHdKaEH8ME-U4Bw3T5ACLcBGAsYHQ/s0/logobranca.png" style="width: 200px;" alt="AutoPrime">
            ...
            <div class="footer-bottom text-center">
                <div class="container">
                    <p>Todos os direitos reservados 2021 - Auto Prime - Proteção Veícular </p>
                </div>
            </div>
        </footer>
        <!--/footer of the page -->
